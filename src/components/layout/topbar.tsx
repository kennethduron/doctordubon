...
export function Topbar({ title, subtitle, showExports = false }: TopbarProps) {
  ...
  return (
    <header className="flex flex-col gap-4 border-b border-border-soft bg-background px-4 py-5 sm:px-6 xl:flex-row xl:items-center xl:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          className="flex h-10 w-10 items-center justify-center rounded-md border border-border-soft bg-white text-sm font-bold text-primary"
          type="button"
